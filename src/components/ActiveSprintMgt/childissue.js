...
const Childissue = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(JSON.stringify(childissue));
        console.log(childissue.type);
        console.log(childissue.summary);
    ...
    const handleDelete = async (childissueId) => {
        try {
            await axios.delete(`http://localhost:8080/childissue/delete/${childissueId}`);
        ...
        <div className='App'>
            <div className='AppGlass'>
                ...
                <div className='childissuePage'>
                    <h2 className="child-issue-title">
                        Active Sprint <i class="bi bi-chevron-right right-arrow"></i> Issue 1
                    </h2>
                    <div class="row">
                        <div class="col-sm-7">
                                ...
                                <div className="scrollbar-content">
                                    ...
                                    <div class="list-group">
                                        <div class="col-12">
                                            ...
                                            <Button
                                                variant="primary"
                                                className="ml-0 rounded bg-[#1e90ff] text-white border-none px-3 py-2 font-semibold transition duration-700 hover:scale-105 hover:bg-[#1e90ff] ease-in-out"
                                                onClick={handleShow}>
                                                Create Child Issue
                                            </Button>
                                            ...
                                            {childissues.map((childissue) => ( // map through the childissues array
                                                <div className="child-issue-row">
                                                    <Link class="card"
                                                        key={childissue.id}
                                                        type="button"
                                                        className="list-group-item list-group-item-action ci-link"
                                                        to={`../CreateChildIssue?childIssueId=${childissue.issueID}`}
                                                    >
                                                        <div style={{ color: '#000' }}>
                                                            <button class='border ci-row-id'>
                                                                {childissue.issueID}
                                                            </button>
                                                            {childissue.summary}
                                                        </div>
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={(event) => {
                                                            ...
                                                            handleDelete(childissue.issueID);
                                                        }}
