...
//   const filteredTeams = teams.filter((team) =>   //Filter the teams array based on the search query
...
//             {!loading && (
//               <tbody className="bg-white">
//                 {filteredTeams.map((team) => (  //Update the rendering of the Team components to use the filteredTeams array instead of teams
//                   <Team
//                     team={team}
//                     deleteTeam={deleteTeam}
//                     openUpdateTeam={openUpdateTeam}
